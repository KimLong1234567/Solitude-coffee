$(document).ready(function () {
  ...
  $('#button-search').click(function () {
    if (
      document.querySelector('input[name="radio-btn-search"]:checked').value ==
      '0'
    ) {
      $('.button-white').attr(
        'formAction',
        './resources/html/search-product.html'
      );
      // document.getElementById("button-search").formAction="./resources/html/search-product.html";
    } else {
      document.getElementById('button-search').formAction =
        './resources/html/search-blog.html';
    }
  });
